...
let g:colors_name='dali_gold_pencil'
...
let s:yellow1     = { "gui": "#ffddaa", "cterm": "255" }
let s:yellow2     = { "gui": "#daac3b", "cterm": "255" }
let s:yellow3     = { "gui": "#a5652c", "cterm": "255" }
let s:yellow4     = { "gui": "#ffe13f", "cterm": "255" }
let s:yellow5     = { "gui": "#805725", "cterm": "255" }
...
if g:pencil_neutral_headings == 1
  ...
  let s:head_a         = s:yellow1
  let s:head_b         = s:yellow2
  let s:head_c         = s:yellow3
endif
...
call s:h("Cursor",        {"bg": s:yellow4, "fg": s:norm })
call s:h("Comment",       {"fg": s:medium_gray, "gui": "italic", "cterm": "italic"})

call s:h("Constant",      {"fg": s:yellow4})
...
call s:h("Identifier",    {"fg": s:yellow3})
hi! link Function         Identifier

call s:h("Statement",     {"fg": s:yellow1})
...
call s:h("PreProc",       {"fg": s:yellow2})
hi! link Include          PreProc
hi! link Define           PreProc
hi! link Macro            PreProc
hi! link PreCondit        PreProc

call s:h("Type",          {"fg": s:yellow2})
hi! link StorageClass     Type
hi! link Structure        Type
hi! link Typedef          Type

call s:h("Special",       {"fg": s:yellow1})
...
call s:h("Error",         {"fg": s:actual_white, "bg": s:yellow2 , "gui": "bold"     , "cterm": "bold"     })
call s:h("Todo",          {"fg": s:actual_white, "bg": s:yellow1, "gui": "bold"     , "cterm": "bold"     })

" ui chrome ====================================================================
" ordered according to `:help hitest.vim`

call s:h("SpecialKey",    {"fg": s:yellow1})
call s:h("NonText",       {"fg": s:bg_subtle})
call s:h("Directory",     {"fg": s:yellow3})
call s:h("ErrorMsg",      {"fg": s:yellow1})
call s:h("IncSearch",     {"bg": s:yellow, "fg": s:light_black})
call s:h("Search",        {"bg": s:bg_subtle})
call s:h("MoreMsg",       {"fg": s:medium_gray, "gui": "bold", "cterm": "bold"})
hi! link ModeMsg MoreMsg
call s:h("LineNr",        {"fg": s:bg_subtle})
call s:h("CursorLineNr",  {"fg": s:yellow4, "bg": s:bg_very_subtle})
call s:h("Question",      {"fg": s:yellow2})
call s:h("StatusLine",    {"bg": s:bg_very_subtle})
call s:h("Conceal",       {"fg": s:norm})
call s:h("StatusLineNC",  {"bg": s:bg_very_subtle, "fg": s:medium_gray})
call s:h("VertSplit",     {"bg": s:bg_very_subtle, "fg": s:bg_very_subtle})
call s:h("Title",         {"fg": s:yellow3})
call s:h("Visual",        {"bg": s:visual})
call s:h("VisualNOS",     {"bg": s:bg_subtle})
call s:h("WarningMsg",    {"fg": s:yellow2})
call s:h("WildMenu",      {"fg": s:bg, "bg": s:norm})
call s:h("Folded",        {"fg": s:medium_gray})
call s:h("FoldColumn",    {"fg": s:bg_subtle})
call s:h("DiffAdd",       {"bg": s:bg_subtle, "fg": s:yellow1})
call s:h("DiffAdded",     {"bg": s:bg_subtle, "fg": s:yellow1})
call s:h("DiffDelete",    {"bg": s:bg_subtle, "fg": s:yellow2})
call s:h("DiffRemoved",   {"bg": s:bg_subtle, "fg": s:yellow2})
call s:h("DiffChange",    {"bg": s:bg_subtle, "fg": s:dark_yellow})
call s:h("DiffChanged",   {"bg": s:bg_subtle, "fg": s:dark_yellow})
call s:h("DiffText",      {"bg": s:bg_subtle, "fg": s:yellow3})
call s:h("SignColumn",    {"fg": s:yellow1})

call s:h("SpellBad",      {"gui": s:sp_un, "sp": s:yellow2, "cterm": s:sp_un, "fg": s:yellow2})
call s:h("SpellCap",      {"gui": s:sp_un, "sp": s:norm, "cterm": s:sp_un, "fg": s:norm})
call s:h("SpellRare",     {"gui": s:sp_un, "sp": s:norm, "cterm": s:sp_un, "fg": s:norm})
call s:h("SpellLocal",    {"gui": s:sp_un, "sp": s:norm, "cterm": s:sp_un, "fg": s:norm})
 
call s:h("Pmenu",         {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuSel",      {"fg": s:norm, "bg": s:yellow4})
call s:h("PmenuSbar",     {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuThumb",    {"fg": s:norm, "bg": s:bg_subtle})
call s:h("TabLine",       {"fg": s:norm, "bg": s:bg_very_subtle})
call s:h("TabLineSel",    {"fg": s:yellow4, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
...
call s:h("htmlLink",      {"fg": s:yellow4  , "gui": "underline"  , "cterm": "underline"})
